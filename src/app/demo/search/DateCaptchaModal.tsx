...
interface DateCaptchaModalProps {
  onSuccess: () => void;
}

type CaptchaType = 'date' | 'date-numpad';

export function DateCaptchaModal({ onSuccess }: DateCaptchaModalProps) {
  ...
  const handleSubmit = () => {
    ...
    if (isValid) {
      ...
      // Yanlış ise yeni CAPTCHA oluştur
      const newCaptcha = generateRandomCaptcha();
      setCaptcha(newCaptcha.value);
      setCaptchaType(newCaptcha.type);
      setInput('');
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-2xl mx-auto animate-[slideUp_0.3s_ease-out] overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-700 px-8 py-6">
          <div className="flex items-center justify-center gap-3">
            ...
            <h2 className="text-2xl font-bold text-white">Tarix yoxlaması</h2>
          </div>
        </div>
        ...
        <div className="p-8">
          ...
          {/* CAPTCHA Display */}
          <div className="bg-gray-100 p-6 rounded-xl border-2 border-gray-300 mb-6 shadow-inner">
            <div className="text-center">
              <div className="text-3xl font-mono font-bold text-gray-800 select-none">
                {captcha}
              </div>
            </div>
          </div>
